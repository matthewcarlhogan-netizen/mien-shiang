 ...
 * three properties below are the ones that CAN be pinned from the markup.
 *
...
test("framing guidance survives a chosen photo", () => {
  // It lived inside `.empty`, which `ui.js` replaces with the chosen image the
  // instant a file is picked. So the advice disappeared at exactly the moment
  // the user could still act on it and retake the shot.
