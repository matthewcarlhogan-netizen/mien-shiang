...
function historyRows(axes, n, { captureClass = "auto", jitter = 0.12, compassOf = null } = {}) {
...
function recordFor({ axesSource, history, confidence, dayIdx, captureClass = "auto" }) {
...
/* ── what the OLD engine renders for a record ────────────────────────────── */
...
/* ── question: repeat exposure over 30 / 90 / 365 days ───────────────────── */
...
function exposureStats(days, pick) {
   ...
   * whether two readings are near-duplicates, and the one §1's "worth
